        ...
        <div className="flex items-start gap-3 flex-1">
          ...
          <div className="flex-1">
            <div className="flex items-center gap-2 mb-1 flex-wrap">
              ...
              {(order.modePaiement === 'PAYSTACK_MOBILE_MONEY' || order.modePaiement === 'PAYSTACK_CARD' || order.modePaiement === 'CHARIOW_MOBILE_MONEY' || (order.montantPaye && order.montantPaye > 0 && order.referencePayment)) && (
