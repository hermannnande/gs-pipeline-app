 ...
 * douce (rose clair). Accent emerald pour le CTA (lie au theme du produit :
 * minceur + fraicheur). Design pense pour une audience feminine.
 *
...
export default function OrderModalMinceur({ open, onClose, cfg, product, setProduct, qtyOptions, initialQty = 1 }: Props) {
  ...
  return (
    ...
    >
      ...
      <div className="relative z-10 w-full max-w-[440px] max-h-[92vh] overflow-hidden rounded-t-3xl bg-gradient-to-b from-rose-50 to-white shadow-2xl animate-[mnslide_.25s_cubic-bezier(.22,.8,.4,1)] sm:rounded-3xl">

        {/* BANDEAU HAUT rose/pink feminin */}
        <div className="relative overflow-hidden bg-gradient-to-br from-pink-500 via-rose-500 to-pink-600 px-5 pt-5 pb-4 text-white">
          ...
          >
            ...
            <div>
              ...
              <input id="mn-name" type="text" value={name} onChange={(e) => setName(e.target.value)} placeholder="Adjoua Kouadio" autoComplete="name" required
                className="block w-full rounded-xl border-[1.5px] border-rose-100 bg-white px-3.5 py-3 text-[14px] font-medium text-rose-900 outline-none transition placeholder:text-rose-300 focus:border-rose-400 focus:ring-2 focus:ring-rose-400/20" />
            </div>
            ...
            <div>
              ...
              <div className="flex overflow-hidden rounded-xl border-[1.5px] border-rose-100 bg-white transition focus-within:border-rose-400 focus-within:ring-2 focus-within:ring-rose-400/20">
                ...
                <input id="mn-phone" type="tel" inputMode="numeric" value={phone}
                  ...
                  className="h-full w-full bg-white px-3 py-3 text-[14px] font-medium text-rose-900 outline-none placeholder:text-rose-300" />
              </div>
            </div>

            <div className="flex items-center justify-between rounded-xl bg-gradient-to-r from-pink-600 via-rose-600 to-pink-600 px-3.5 py-3 text-white shadow-[inset_0_1px_0_rgba(255,255,255,0.2)]">
            ...
            <p className="text-center text-[11px] font-medium text-rose-400">🔒 Paiement à la livraison · Satisfaite ou remboursée</p>
          </form>
        </div>
      </div>
