/**
 * Modal commande — Creme Anti-Lipome TK (CREME_ANTI_LIPOME_TK).
...
export default function OrderModalCremeAntiLipomeTk({ open, onClose, cfg, product, setProduct, qtyOptions, initialQty = 1 }: Props) {
            ...
            <div className="flex items-center gap-2.5">
              ...
              <div>
                <h3 id="cal-title" className="text-[15px] font-black leading-tight text-emerald-950">
                  Crème <span className="bg-gradient-to-r from-emerald-600 to-lime-600 bg-clip-text text-transparent">anti-lipome TK</span>
                </h3>
