...
export default function OrderModalPoudreCheveux({ open, onClose, cfg, product, setProduct, qtyOptions, initialQty = 1 }: Props) {
  ...
  return (
    ...
    >
      ...
      <div className="relative z-10 w-full max-w-[420px] max-h-[100dvh] overflow-hidden rounded-t-[20px] bg-[#fdfbf7] shadow-2xl animate-[ppcmslide_.25s_cubic-bezier(.22,.8,.4,1)] sm:rounded-[20px]">

        {/* Liseret or rose en haut */}
        <div className="h-0.5 w-full bg-gradient-to-r from-transparent via-amber-400 via-rose-300 to-transparent"/>

        {/* ===== HEADER emerald + or rose ===== */}
        <div className="relative overflow-hidden bg-gradient-to-br from-emerald-950 via-emerald-900 to-emerald-950 px-5 pt-4 pb-4 text-white">
        ...
        <div className="px-5 py-4">
          ...
          >
            ...
            {/* Total */}
            <div className="relative overflow-hidden rounded-[0.8rem] bg-gradient-to-br from-emerald-950 via-emerald-900 to-emerald-950 px-4 py-3 text-white shadow-inner">
