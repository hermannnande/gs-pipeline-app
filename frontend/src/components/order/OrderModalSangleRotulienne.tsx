...
export default function OrderModalSangleRotulienne({ open, onClose, cfg, product, setProduct, qtyOptions, initialQty = 1 }: Props) {
      ...
      <div className="relative z-10 flex max-h-[94vh] w-full max-w-[420px] flex-col overflow-hidden rounded-t-[28px] bg-gradient-to-b from-[#EFF6FF] to-white shadow-2xl sm:rounded-3xl">
        ...
        >
          ...
          <button type="submit" disabled={sending}
            className="flex h-[54px] w-full items-center justify-center rounded-2xl bg-gradient-to-r from-[#1D4ED8] via-[#06B6D4] to-[#F97316] text-[15px] font-black text-white shadow-[0_14px_36px_-10px_rgba(29,78,216,.55)] transition hover:brightness-110 active:scale-[0.99] disabled:opacity-60">
