/**
 * Page de remerciement dediee a /creme-anti-cerne-offre (variante RETARGETING)
 * Pixel Meta campagne : 2289664558455796
 *   - PageView au mount
...
const TEMPLATE_SLUG = 'creme-anti-cerne-offre';
        ...
        <div className="relative mx-auto w-full max-w-[640px]">
          <div className="relative overflow-hidden rounded-[32px] bg-white p-6 shadow-[0_30px_80px_-20px_rgba(244,63,94,.30)] ring-1 ring-rose-100 sm:p-10">
            ...
            <div className="mt-6 text-center">
              <Link
                to={`/creme-anti-cerne-offre?company=${encodeURIComponent(company)}`}
