/**
 * Landing premium — Support Téléphone Flexible Mains Libres, variante TIKTOK (SUPPORT_TELEPHONE_FLEXIBLE_TK).
 * Slug : support-telephone-flexible-tk · Prix : 7 900 / 14 900 / 19 900 F (-50 % affiché) · Livraison aux frais du client
...
const PRODUCT_CODE = 'SUPPORT_TELEPHONE_FLEXIBLE_TK'; // Produit dedie : commandes TikTok separees dans obgestion
...
const THANK_YOU_URL = '/support-telephone-flexible-tk/merci';
...
/* Landing                                                             */
/* ================================================================== */
export default function SupportTelephoneFlexibleTkLanding() {
