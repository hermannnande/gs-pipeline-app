/**
 * Tunnel de vente — Crème Anti-Lipome TK (CREME_ANTI_LIPOME_TK)
 * Slug: creme-anti-lipome-tk — doublon tunnel lipome pour tracking campagne separe.
 *
...
// Main
// ============================================================================
export default function CremeAntiLipomeTkLanding() {
  ...
  return (
    <div className="min-h-screen bg-[#f4faf6]" style={{ fontFamily: 'system-ui,-apple-system,Segoe UI,Roboto,Helvetica,Arial,sans-serif' }}>
          ...
          <div className="overflow-hidden rounded-2xl shadow-2xl">
            <div className="flex items-center gap-3 bg-[#075e54] px-4 py-3 text-white">
              ...
              <div className="flex-1">
                <p className="text-[13px] font-black">GS · Crème anti-lipome TK</p>
      ...
      <footer className="bg-emerald-950 py-7 text-center text-[10px] font-semibold text-emerald-300/70">
        © {new Date().getFullYear()} · Crème anti-lipome TK · Usage externe · Résultats variables selon les individus
      </footer>
