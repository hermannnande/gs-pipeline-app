/**
 * Tunnel premium — Patch Minceur GLP Promo (PATCH_MINCEUR_PROMO).
 * Duplication slug patch-minceur-promo · médias partagés patch-minceur-glp
 * Prix promo : 7 500 / 14 000 / 20 000 FCFA
 */
...
const THANK_YOU_URL = '/patch-minceur-promo/merci';

const PRICES: Record<number, number> = { 1: 7500, 2: 14000, 3: 20000 };
const fmtTotal = (qty: number) => orderTotal(PRICES, qty).toLocaleString('fr-FR').replace(/\u202f|,/g, ' ');
const QTY_OPTS = [
  { v: 1, label: '1 paquet',  sub: packLabel(PRICES, 1, 'F'), save: '' },
  { v: 2, label: '2 paquets', sub: packLabel(PRICES, 2, 'F'), tag: 'Le + choisi', save: 'Économisez 1 000 F' },
  { v: 3, label: '3 paquets', sub: packLabel(PRICES, 3, 'F'), tag: 'Meilleure offre', save: 'Économisez 2 500 F' },
];
...
export default function PatchMinceurPromoLanding() {
