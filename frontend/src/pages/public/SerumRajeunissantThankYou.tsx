/**
 * Page merci — Sérum Rajeunissant Anti-Âge Yeux (slug serum-rajeunissant).
...
export default function SerumRajeunissantThankYou() {
    ...
    <div className="flex min-h-screen items-center justify-center bg-gradient-to-b from-[#FFF6EF] via-[#FDF0F5] to-[#F3E8FF] px-4 py-10">
      <div className="w-full max-w-md overflow-hidden rounded-[28px] border border-[#F4A7C3]/40 bg-white shadow-2xl">
        ...
        <div className="space-y-4 p-5">
          ...
          <Link to="/serum-rajeunissant" className="block rounded-full bg-gradient-to-r from-[#7B4B2A] via-[#E8739E] to-[#A855F7] py-3.5 text-center text-[12px] font-black uppercase tracking-[0.12em] text-white shadow-lg transition hover:brightness-110">
            Retour au produit
          </Link>
        </div>
      </div>
