/**
 * Tunnel premium — Bande sport minceur (BANDE_SPORT_MINCEUR_TK).
 * Duplication canal TikTok Ads · Slug : bande-sport-tk · Prix : 7 000 / 12 000 / 15 000 F
 * Médias partagés avec bande-sport-minceur (même dossier public).
 */
...
const PRODUCT_CODE = 'BANDE_SPORT_MINCEUR_TK';
const CONTENT_NAME = 'Bande sport minceur';
const META_PIXEL_ID = '';
const THANK_YOU_URL = '/bande-sport-tk/merci';
...
export default function BandeSportTkLanding() {
