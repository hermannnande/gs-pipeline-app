...
export const LANDING_COMPONENTS: Record<string, LazyLanding> = {
  ...
  'creme-anti-verrue-bleu-tk': lazy(() => import('./CremeAntiVerrueBleuTkLanding')),
  'promo-verrue': lazy(() => import('./CremeAntiVerrueBleuPromoLanding')),
  patchdouleurtk: lazy(() => import('./PatchDouleurTkLanding')),
  patchdouleurfb: lazy(() => import('./PatchDouleurFbLanding')),
  patchdouleurtiktok: lazy(() => import('./PatchDouleurTiktokLanding')),
  ...
  'bande-sport-tk': lazy(() => import('./BandeSportTkLanding')),
  detoxminceur: lazy(() => import('./DetoxMinceurLanding')),
  'patch-minceur-glp': lazy(() => import('./PatchMinceurGlpLanding')),
  'patch-minceur-promo': lazy(() => import('./PatchMinceurPromoLanding')),
  ...
  'support-telephone-flexible': lazy(() => import('./SupportTelephoneFlexibleLanding')),
