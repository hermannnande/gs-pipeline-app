/**
 * Tunnel de vente PREMIUM — Crème Anti-Verrues bleue (TikTok Ads).
 * Slug : creme-anti-verrue-bleu-tk · productCode : CREME_ANTI_VERRUE_BLEU_TK
 * Duplication canal TikTok · même design/médias que creme-anti-verrue-bleu · sans pixel Meta.
 */
...
const PRODUCT_CODE = 'CREME_ANTI_VERRUE_BLEU_TK';
const CONTENT_NAME = 'Crème Anti-Verrues';
const THANK_YOU_URL = '/creme-anti-verrue-bleu-tk/merci';
const META_PIXEL_ID = '';
...
export default function CremeAntiVerrueBleuTkLanding() {
