/**
 * Landing ULTRA PREMIUM — Serum Anti-Cernes TK (SERUM_CERNE_TK) — clone exact de serum-cerne
 * ==================================================================
 *
...
const PRODUCT_CODE = 'SERUM_CERNE_TK';
...
// Main component
// =========================================================
export default function SerumCerneTkLanding() {
  ...
  return (
    <div className="min-h-screen bg-[#faf8f5] text-slate-900" style={{ fontFamily: "'Inter',system-ui,-apple-system,sans-serif" }}>
      ...
      <Marquee
        variant="gold"
        items={['Serum Anti-Cernes TK Premium', 'Rajeunissement visible', 'Formule dermatologique', 'Sans effet secondaire', 'Livraison 24h Abidjan', 'Paiement a la livraison']}
      />
        ...
        <div className="relative mx-auto max-w-3xl px-4 pb-12 pt-8 text-center sm:pt-12 md:pt-16">
          ...
          <div className="relative mt-8 sc-fade-up" style={{ animationDelay: '.15s' }}>
            ...
            <div className="relative mx-auto max-w-md overflow-hidden rounded-[2rem] bg-white shadow-[0_25px_70px_-12px_rgba(15,33,55,.25)] ring-1 ring-amber-300/30 sc-bob">
              <LazyImg src={MEDIA.hero} alt="Serum Anti-Cernes TK" aspect="4/5" priority/>
      ...
      <OrderModalDispatcher
        ...
        cfg={{
          ...
          title: 'Serum Anti-Cernes TK Premium',
          prices: PRICES,
