/**
 * Page merci — Ajusteur de Ceinture Élastique (slug ajusteur-ceinture).
...
export default function AjusteurCeintureThankYou() {
  ...
  return (
    <div className="flex min-h-screen items-center justify-center bg-gradient-to-b from-[#EEF2FF] via-[#E0E7FF] to-[#FFF7ED] px-4 py-10">
      <div className="w-full max-w-md overflow-hidden rounded-[28px] border border-[#818CF8]/40 bg-white shadow-2xl">
        <div className="bg-gradient-to-br from-[#1E3A8A] via-[#6D28D9] to-[#F59E0B] px-6 py-8 text-center text-white">
        ...
        <div className="space-y-4 p-5">
          {ref && (
            <div className="rounded-xl bg-[#EEF2FF] p-3 text-center ring-1 ring-[#818CF8]/40">
          ...
          <Link to="/ajusteur-ceinture" className="block rounded-full bg-gradient-to-r from-[#1E3A8A] via-[#6D28D9] to-[#F59E0B] py-3.5 text-center text-[12px] font-black uppercase tracking-[0.12em] text-white shadow-lg transition hover:brightness-110">
            Retour au produit
          </Link>
        </div>
      </div>
