/**
 * Landing « MÉDICAL 2026 » — Oxymètre de Pouls Digital, variante TIKTOK (OXYMETRE_POULS_TK).
 * Slug : oxymetre-pouls-tk · Prix : 8 500 / 15 900 / 22 900 F (-50 % affiché)
 * Variante TikTok : meme tunnel que la version Meta (zigzag scroll-reveal, hero
 * ECG/coeur pulsant, section 3 etapes, conformite conservee), signature
 * indigo/violet nuit #1E1B4B / #6D28D9 + cyan, rouge coeur conserve.
 * Stats separees dans obgestion (produit dedie).
 * Pixel Meta desactive — Pixel TikTok : renseigner TIKTOK_PIXEL_ID.
 * Medias partages avec la page Meta (/oxymetre-pouls/*).
 */
...
const SLUG = 'oxymetre-pouls-tk';
const PRODUCT_CODE = 'OXYMETRE_POULS_TK'; // Produit dedie : commandes TikTok separees dans obgestion
...
const THANK_YOU_URL = '/oxymetre-pouls-tk/merci';
...
type CtaVariant = 'violet' | 'cyan' | 'emerald' | 'red' | 'noir';
  ...
  return (
    <div ref={ref} className="overflow-hidden" style={aspect ? { aspectRatio: aspect } : undefined}>
      {visible ? (
        ...
        <div className="h-full min-h-[260px] w-full animate-pulse bg-gradient-to-br from-[#4F46E5]/20 to-[#7C3AED]/15" />
      )}
    </div>
  );
}
...
function StickyCTA({ visible, onClick }: { visible: boolean; onClick: () => void }) {
  return (
    ...
    >
      <div className="border-t border-white/25 bg-gradient-to-r from-[#1E1B4B]/95 via-[#6D28D9]/95 to-[#312E81]/95 shadow-[0_-10px_34px_-10px_rgba(11,30,75,.5)] backdrop-blur-md">
...
function Marquee({ items, dark }: { items: string[]; dark?: boolean }) {
  return (
    <div className={`overflow-hidden py-2.5 ${dark
      ? 'border-y border-[#06B6D4]/30 bg-gradient-to-r from-[#1E1B4B] via-[#6D28D9] to-[#1E1B4B] text-[#DBEAFE]'
      : 'border-y border-white/40 bg-gradient-to-r from-[#4F46E5] via-[#7C3AED] to-[#06B6D4] text-white'}`}>
  ...
  return (
    ...
    >
      <div className="flex items-center gap-3 rounded-2xl bg-white/95 p-3 pr-4 shadow-[0_16px_40px_-12px_rgba(11,30,75,.35)] ring-1 ring-[#93C5FD]/50 backdrop-blur-md">
        <span className="flex h-10 w-10 shrink-0 items-center justify-center rounded-full bg-gradient-to-br from-[#4F46E5] to-[#7C3AED] text-[15px] font-black text-white">
          {it.n[0]}
        </span>
...
function TestimonialCard({ r }: { r: (typeof TESTIMONIALS)[number] }) {
  return (
    <div className="rounded-2xl bg-white/85 p-4 shadow-lg ring-1 ring-[#1D4ED8]/15">
      <div className="flex items-center gap-3">
        <span className="flex h-10 w-10 shrink-0 items-center justify-center rounded-full bg-gradient-to-br from-[#4F46E5] via-[#7C3AED] to-[#06B6D4] text-[15px] font-black text-white">
          {r.n[0]}
        </span>
...
/* Landing                                                             */
/* ================================================================== */
export default function OxymetresPoulsTkLanding() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-[#EEF2FF] via-[#E0E7FF] to-[#F5F3FF] pb-28 text-neutral-900">
      <style>{`
        ...
        .ox-grad { background: linear-gradient(120deg,#4F46E5,#7C3AED 50%,#06B6D4); -webkit-background-clip:text; background-clip:text; color: transparent; }
        ...
        .ox-cta-violet { background-image: linear-gradient(90deg,#4C1D95,#6D28D9,#A78BFA); }
      ...
      <section className="relative overflow-hidden px-4 pb-10 pt-8">
        ...
        <div className="relative mx-auto max-w-[560px] text-center">
          <div className="flex flex-wrap items-center justify-center gap-2">
            <span className="inline-flex rounded-full bg-gradient-to-r from-[#4F46E5] to-[#7C3AED] px-3 py-1 text-[10px] font-black uppercase tracking-[0.14em] text-white">🫀 Résultat en 8 secondes</span>
          ...
          <div className="relative mx-auto mt-6 max-w-[440px]">
            <div className="absolute -inset-3 rounded-[36px] bg-gradient-to-r from-[#4F46E5]/20 via-[#7C3AED]/25 to-[#06B6D4]/20 blur-xl" />
      ...
      {/* ==================== COMPTE À REBOURS ==================== */}
      <section className="bg-gradient-to-r from-[#1E1B4B] via-[#6D28D9] to-[#4C1D95] px-4 py-8">
      ...
      <ZigBlock
        ...
        side="left"
        bg="bg-gradient-to-b from-[#1E1B4B] via-[#6D28D9] to-[#312E81]"
          ...
          <div className="mt-7 grid gap-4 sm:grid-cols-3">
            {[
              ...
              <div key={s.n} className="relative rounded-2xl bg-white/85 p-5 text-center shadow-lg ring-1 ring-[#1D4ED8]/15">
                <span className="absolute -top-3 left-1/2 flex h-7 w-7 -translate-x-1/2 items-center justify-center rounded-full bg-gradient-to-r from-[#4F46E5] to-[#7C3AED] text-[13px] font-black text-white">{s.n}</span>
      ...
      <ZigBlock
        ...
        side="right"
        bg="bg-gradient-to-b from-[#1E1B4B] via-[#4C1D95] to-[#6D28D9]"
      ...
      <section className="bg-gradient-to-b from-[#ECFEFF] to-[#A5F3FC]/40 px-4 py-12">
        <div className="mx-auto max-w-[560px]">
          ...
          <div className="mx-auto mt-6 max-w-sm"><OxCTA variant="violet" onClick={() => openModal()}>Rejoindre les familles équipées</OxCTA></div>
        </div>
      </section>
      ...
      {/* ==================== OFFRE / URGENCE ==================== */}
      <section className="bg-gradient-to-b from-[#1E1B4B] via-[#6D28D9] to-[#312E81] px-4 py-12 text-white">
        <div className="mx-auto max-w-[560px] text-center">
      ...
      <footer className="bg-gradient-to-b from-[#1E1B4B] to-[#312E81] px-4 pb-8 pt-6 text-center text-[10.5px] text-white/60">
