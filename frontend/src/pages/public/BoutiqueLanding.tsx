...
import guidePosterImg from '../../assets/guide/video-guide-poster.webp';
...
const PRODUCTS: Product[] = [
  ...
  },
  {
    slug: 'creme-eczema',
    href: '/creme-eczema',
    name: 'Creme Eczema Apaisante',
    tagline: 'Calme demangeaisons et rougeurs',
    hero: '/creme-eczema/n1.webp',
    badge: 'Nouveau',
    badgeColor: 'emerald',
    price: '9 500 F',
    oldPrice: '15 000 F',
  ...
  },
  {
    ...
    href: '/chaussette-premium-homme',
    name: 'Chaussettes Premium Homme',
    tagline: 'Elegance et confort au quotidien',
    hero: '/chaussette-premium-homme/hero.webp',
    badge: 'Premium',
    badgeColor: 'amber',
    price: '9 900 F',
    oldPrice: '15 000 F',
  ...
  },
  {
    slug: 'chaussette',
    href: '/chaussette',
    name: 'Chaussettes Chauffantes Tourmaline',
    tagline: 'Chaleur et circulation des pieds',
    hero: '/chaussette/hero.webp',
    badge: 'Confort',
    badgeColor: 'cyan',
    price: '6 500 F',
    oldPrice: '12 000 F',
  ...
  },
  {
    ...
    href: '/spray-vitiligo',
    name: 'Spray Vitiligo',
    tagline: 'Reunifie le teint de la peau',
    hero: '/spray-vitiligo/hero.webp',
    badge: 'Nouveau',
    badgeColor: 'violet',
    price: '9 900 F',
    oldPrice: '15 000 F',
  ...
  },
  {
    slug: 'chapeau-dame',
    href: '/chapeau-dame',
    name: 'Chapeau Dame Elegance',
    tagline: 'L\'accessoire chic de vos tenues',
    hero: '/chapeau-dame/hero-poster.webp',
    badge: 'Tendance',
    badgeColor: 'rose',
    price: '9 900 F',
    oldPrice: '15 000 F',
  ...
  },
  {
    ...
    href: '/chapeau-gavroche',
    name: 'Chapeau Gavroche',
    tagline: 'Style retro-chic intemporel',
  ...
  {
    slug: 'bande-sport-minceur',
    href: '/bande-sport-minceur',
    name: 'Bande Sport Minceur',
    tagline: 'Sculpte la silhouette a l\'effort',
    hero: '/bande-sport-minceur/hero.webp',
    badge: 'Sport',
    badgeColor: 'cyan',
    price: '7 000 F',
    oldPrice: '12 000 F',
    category: 'Minceur · Sport',
  },
  {
    slug: 'detoxminceur',
    href: '/detoxminceur',
    name: 'Cure Detox Minceur',
    tagline: 'Draine et affine de l\'interieur',
    hero: '/detoxminceur/hero.webp',
    badge: 'Detox',
    badgeColor: 'emerald',
    price: '9 900 F',
    oldPrice: '15 000 F',
    category: 'Minceur · Bien-etre',
  },
  {
    slug: 'patch-minceur-glp',
    href: '/patch-minceur-glp',
    name: 'Patch Minceur GLP',
    tagline: 'Action minceur en continu',
    hero: '/patch-minceur-glp/hero.webp',
    badge: 'Nouveau',
    badgeColor: 'rose',
    price: '9 900 F',
    oldPrice: '15 000 F',
  ...
  {
    slug: 'lunette-de-nuit',
    href: '/lunette-de-nuit',
    name: 'Lunettes de Conduite de Nuit',
    tagline: 'Conduisez sans eblouissement',
    hero: '/lunette-de-nuit/m1.webp',
    badge: 'Securite',
    badgeColor: 'cyan',
    price: '7 000 F',
    oldPrice: '12 000 F',
    category: 'Auto · Confort',
  },
  {
    slug: 'bouilloire-intelligente',
    href: '/bouilloire-intelligente',
    name: 'Bouilloire Intelligente',
    tagline: 'Temperature precise, the parfait',
    hero: '/bouilloire-intelligente/hero.webp',
    badge: 'Maison',
    badgeColor: 'violet',
    price: '8 500 F',
    oldPrice: '14 000 F',
  ...
  {
    slug: 'coffret-boxer-luxe-v3',
    href: '/coffret-boxer-luxe-v3',
    name: 'Boxers Homme de Luxe',
    tagline: 'Confort premium au quotidien',
    hero: '/coffret-boxer-luxe-v3/hero-poster.webp',
    badge: 'Luxe',
    badgeColor: 'amber',
    price: '7 000 F',
    oldPrice: '12 000 F',
  ...
  {
    slug: 'guide-pousse-naturelle',
    href: '/guide-pousse-naturelle',
