/**
 * Page de remerciement dediee a /creme-anti-verrue (coachingexpertci.com, etc.)
 * Pixel Meta campagne : 974673311723451 — Purchase + PageView pour dedoublonnage CAPI.
 */
...
const PRODUCT_NAME = 'Creme Anti-Verrues Botanique';
...
export default function CremeAntiVerrueThankYou() {
  ...
  useEffect(() => {
    ...
    const sessionKey = ref ? `cav_purchase_${ref}` : '';
    ...
    const firePurchase = () => {
      try {
        ...
        console.warn('[CremeAntiVerrueThankYou] Purchase non bloquant:', e);
      }
    };
        ...
        <div className="overflow-hidden rounded-2xl border border-neutral-100 bg-white shadow-xl">
          ...
          <div className="space-y-4 p-5">
            ...
            <div className="flex flex-col gap-2 sm:flex-row">
              <Link
                to={`/creme-anti-verrue?company=${encodeURIComponent(company)}`}
