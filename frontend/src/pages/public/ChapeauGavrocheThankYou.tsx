/**
 * Page de remerciement dediee Chapeau Gavroche (CHAPEAU_GAVROCHE).
 *
 ...
 * campagne FB Ads.
 *
 * Pixel : 1613380123108753 (partage avec la campagne chaussette-homme).
 *
 ...
 *
 * Style : palette noir + or + ivoire (cohérence avec ChapeauGavrocheLanding).
 */
...
export default function ChapeauGavrocheThankYou() {
  ...
  useEffect(() => {
    document.title = 'Merci pour votre commande — Chapeau Gavroche';
  }, []);

  useEffect(() => {
    initMetaPixel(META_PIXEL_ID);

    const sessionKey = ref ? `cg_purchase_${ref}` : '';
  ...
  return (
    <div className="min-h-screen overflow-x-hidden bg-[#faf7f0] text-stone-900 antialiased">
      {/* Top strip noir + or */}
      <div className="bg-gradient-to-r from-[#0a0a0a] via-stone-900 to-[#0a0a0a] px-4 py-2 text-center text-[10px] font-black uppercase tracking-[0.32em] text-white sm:text-[11px]">
        <span className="text-amber-300">Commande confirmée</span>
        <span className="mx-2 opacity-50">·</span>
        <span>Chapeau Gavroche · Côte d'Ivoire</span>
      </div>

      <main className="relative overflow-hidden px-4 pb-16 pt-12 sm:px-6 sm:pb-24 sm:pt-16">
        {/* Halos lumineux fond */}
        <div className="pointer-events-none absolute -right-24 -top-24 h-[480px] w-[480px] rounded-full bg-amber-300/25 blur-[120px]" />
        <div className="pointer-events-none absolute -bottom-24 -left-24 h-[480px] w-[480px] rounded-full bg-amber-200/30 blur-[120px]" />

        <div className="relative mx-auto w-full max-w-[640px]">
          {/* Card centrale */}
          <div className="relative overflow-hidden rounded-[32px] bg-white p-6 shadow-[0_30px_80px_-20px_rgba(10,10,10,0.35)] ring-1 ring-amber-300/50 sm:p-10">
            <div className="pointer-events-none absolute inset-x-0 top-0 h-1 bg-gradient-to-r from-amber-500 via-yellow-300 to-amber-600" />

            {/* Pastille check or */}
            <div className="mx-auto mb-6 flex h-20 w-20 items-center justify-center rounded-full bg-gradient-to-br from-amber-400 via-yellow-300 to-amber-500 shadow-[0_15px_40px_-10px_rgba(212,175,55,0.6)]">
              <svg className="h-9 w-9 text-stone-950" fill="none" stroke="currentColor" strokeWidth={3.5} viewBox="0 0 24 24">
            ...
            <div className="text-center">
              ...
              <h1 className="mt-4 text-[30px] font-black leading-[1.05] tracking-tight text-stone-950 sm:text-[38px]">
                Merci pour votre <span className="bg-gradient-to-r from-amber-600 via-yellow-500 to-amber-700 bg-clip-text text-transparent">commande</span> !
              </h1>
              <p className="mt-3 text-[14px] leading-relaxed text-stone-700 sm:text-[15px]">
            ...
            <div className="mt-6 rounded-2xl bg-gradient-to-br from-[#0a0a0a] via-stone-900 to-[#0a0a0a] p-4 text-white ring-1 ring-amber-300/30">
              <div className="grid grid-cols-2 gap-3 text-[12px]">
                <div>
                  <p className="text-[9px] font-black uppercase tracking-[0.3em] text-amber-300">Quantité</p>
                  <p className="mt-1 text-[18px] font-black tabular-nums">{qty} chapeau{qty > 1 ? 'x' : ''}</p>
            ...
            <div className="mt-6">
              ...
              <ol className="mt-3 space-y-3">
                {[
                  ...
                  { n: '2', t: 'Livraison rapide', d: "Votre chapeau arrive sous 24-48 h partout en Côte d'Ivoire." },
                  ...
                  <li key={s.n} className="flex gap-3 rounded-xl bg-stone-50 p-3 ring-1 ring-amber-100">
                    <div className="flex h-8 w-8 shrink-0 items-center justify-center rounded-full bg-gradient-to-br from-[#0a0a0a] to-stone-800 text-[13px] font-black text-amber-300 shadow-[0_5px_15px_-3px_rgba(0,0,0,0.5)] ring-1 ring-amber-300/40">
                      {s.n}
                    </div>
            ...
            <div className="mt-6 text-center">
              <Link
                to="/chapeau-gavroche"
                className="inline-flex items-center gap-2 rounded-full bg-gradient-to-r from-[#0a0a0a] via-stone-800 to-[#0a0a0a] px-5 py-2.5 text-[11px] font-black uppercase tracking-[0.18em] text-amber-300 shadow-[0_10px_25px_-5px_rgba(0,0,0,0.5)] ring-2 ring-amber-300/30 transition hover:-translate-y-0.5 hover:shadow-[0_15px_35px_-5px_rgba(0,0,0,0.7)]"
              >
                Retour au produit
          ...
          <p className="mt-6 text-center text-[11px] text-amber-700/70">
            Chapeau Gavroche · Édition Premium 2026 · Côte d'Ivoire
          </p>
        </div>
      </main>
    </div>
