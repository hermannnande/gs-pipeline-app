...
const PRODUCT_CODE = 'SPRAY_LIPOME_PROMO';
const META_PIXEL_ID = ''; // page SMS : aucun pixel Facebook (trafic SMS uniquement)
const THANK_YOU_URL = '/spraylipome-promo/merci';
...
const QTY_OPTS = [
  ...
  { v: 2, label: '2 sprays', sub: packLabel(PRICES, 2, 'FCFA'), tag: 'Populaire', save: 'Economisez 1 000 F' },
  { v: 3, label: '3 sprays', sub: packLabel(PRICES, 3, 'FCFA'), tag: 'Meilleure offre', save: 'Economisez 2 500 F' },
];
...
// Main component
// =========================================================
export default function SprayLipomePromoLanding() {
        ...
        <div className="relative mx-auto max-w-3xl px-4 pb-10 pt-6 text-center sm:pt-10 md:pt-14 md:pb-14">
          ...
          <div className="mt-8 sl-fade-up" style={{ animationDelay: '.2s' }}>
            <div className="flex items-baseline justify-center gap-3">
              ...
              <span className="rounded-full bg-gradient-to-r from-amber-300 to-yellow-300 px-2 py-0.5 text-[10px] font-black uppercase tracking-wider text-purple-900 shadow">-50%</span>
            </div>
