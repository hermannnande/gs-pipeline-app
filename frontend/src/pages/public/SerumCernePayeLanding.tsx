/**
 * Landing ULTRA PREMIUM — Serum Anti-Cernes PAYE (SERUM_CERNE_PAYE) — 3eme clone de serum-cerne
 * ==================================================================
 *
...
// Main component
// =========================================================
export default function SerumCernePayeLanding() {
  ...
  useEffect(() => {
    document.body.style.overflow = (modal || exitPopup || choiceOpen) ? 'hidden' : '';
    return () => { document.body.style.overflow = ''; };
  }, [modal, exitPopup, choiceOpen]);

  // openModal -> ouvre d'abord la popup CHOIX DE PAIEMENT (specifique a cette page).
  // Le modal de commande final ne s'ouvre qu'apres le choix du client.
  ...
  return (
    <div className="min-h-screen bg-[#faf8f5] text-slate-900" style={{ fontFamily: "'Inter',system-ui,-apple-system,sans-serif" }}>
      ...
      <Marquee
        variant="gold"
        items={['Serum Anti-Cernes Premium', 'Rajeunissement visible', 'Formule dermatologique', 'Sans effet secondaire', 'Livraison 24h Abidjan', 'Paiement Mobile Money OU livraison']}
      />
      ...
      <section className="sc-cv relative overflow-hidden py-16 sm:py-24">
        ...
        <div className="relative mx-auto max-w-3xl px-4 text-center text-white">
          ...
          <p className="mt-4 text-[14px] text-stone-300 sm:text-[16px]">
            Serum Anti-Cernes Premium · {fmtTotal(1)} FCFA · Mobile Money ou Cash a la livraison
          </p>
      ...
      <PaymentChoicePopup
        ...
        paystackPrice={fmt(Math.round((orderTotal(PRICES, qty || 1) * 0.9 / 10) * 10))}
      />
      ...
      <OrderModalDispatcher
        ...
        cfg={{
          ...
          // Specifique serum-cerne-paye : passer le mode de paiement choisi
          // dans la popup, et permettre au client de revenir sur son choix.
          initialPaymentMode: paymentMode,
          onChangePaymentMode: reopenChoice,
        } as any}
        product={product}
