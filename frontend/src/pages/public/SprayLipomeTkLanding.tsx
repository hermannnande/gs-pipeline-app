/**
 * Landing ULTRA PREMIUM — Spray Anti-Lipome TK (LIPOME_SPRAY_TK)
 * Duplicate de SprayLipomeLanding (meme design, memes medias, mapping different).
 * ==================================================================
 *
 ...
 *   - spraylipome       : POURPRE + MAGENTA + OR ROSE (luxe medical)
 *   - spraylipometk     : meme design que spraylipome, mapping LIPOME_SPRAY_TK
 *
...
const SLUG = 'spraylipometk';
const PRODUCT_CODE = 'LIPOME_SPRAY_TK';
const META_PIXEL_ID = '952340034030644';
const THANK_YOU_URL = '/spraylipometk/merci';
...
// Main component
// =========================================================
export default function SprayLipomeTkLanding() {
