 ...
 * Slug : bandes-buccales-sommeil · Prix : 8 500 / 15 900 / 22 900 F (-50 % affiché)
 *
 * Palette IMPOSEE par le client (couleurs du produit, boite noire Premium Tape) :
 *   NOIR CHARBON #0A0A0F / #111118  (fonds profonds, fini l'indigo violace)
 *   OR / AMBRE #F59E0B / #FCD34D    (couleur d'action dominante : prix, CTA, etoiles)
 *   BLEU ROI ELECTRIQUE #1E3A8A -> #3B82F6 (halos, marquee, accents froids)
 *
 * Contenu ALLEGE (demande client) : page qui se scanne en 10 secondes.
 * Pas de paragraphes descriptifs : titres courts, micro-accroches 3-7 mots
 * sous chaque media, FAQ resserree, garantie courte. Le regard va d'image
 * en bouton. Tracking / formulaire / prix / medias : inchanges.
 */
