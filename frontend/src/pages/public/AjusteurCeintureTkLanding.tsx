/**
 * Landing premium — Ajusteur de Ceinture Élastique, variante TIKTOK (AJUSTEUR_CEINTURE_TK).
 * Slug : ajusteur-ceinture-tk · Prix : 6 900 / 12 900 / 16 900 F (-50 % affiché)
 * Variante TikTok : meme tunnel que la version Meta (carrousel file d'attente 1 s,
 * 10 blocs, CTAs animes), mais signature violette/rose (nuit #1A0B2E / #701A75,
 * rose #F472B6, or #FCD34D). Stats separees dans obgestion (produit dedie).
 * Pixel Meta desactive — Pixel TikTok : renseigner TIKTOK_PIXEL_ID.
 * Medias partages avec la page Meta (/ajusteur-ceinture/*).
 */
...
const SLUG = 'ajusteur-ceinture-tk';
const PRODUCT_CODE = 'AJUSTEUR_CEINTURE_TK'; // Produit dedie : commandes TikTok separees dans obgestion
...
const THANK_YOU_URL = '/ajusteur-ceinture-tk/merci';
...
type CtaVariant = 'gold' | 'rose' | 'violet' | 'emerald' | 'noir';
  ...
  return (
    <div ref={ref} className="overflow-hidden" style={aspect ? { aspectRatio: aspect } : undefined}>
      {visible ? (
        ...
        <div className="h-full min-h-[260px] w-full animate-pulse bg-gradient-to-br from-[#701A75]/25 to-[#A78BFA]/20" />
      )}
    </div>
  );
}
...
function LazyVideo({ src, poster, badge }: { src: string; poster?: string; badge?: string }) {
  const { ref, visible } = useOnScreen();
  return (
    <div ref={ref} className="relative w-full overflow-hidden bg-[#1A0B2E]" style={{ aspectRatio: '9/16' }}>
      {visible ? (
...
function StickyCTA({ visible, onClick }: { visible: boolean; onClick: () => void }) {
  return (
    ...
    >
      <div className="border-t border-[#F59E0B]/30 bg-gradient-to-r from-[#1A0B2E]/95 via-[#701A75]/95 to-[#312E81]/95 shadow-[0_-10px_34px_-10px_rgba(20,20,43,.6)] backdrop-blur-md">
...
function Marquee({ items, gold }: { items: string[]; gold?: boolean }) {
  return (
    <div className={`overflow-hidden py-2.5 ${gold
      ...
      : 'border-y border-[#A78BFA]/25 bg-gradient-to-r from-[#1A0B2E] via-[#701A75] to-[#312E81] text-[#E9D5FF]'}`}>
  ...
  return (
    ...
    >
      <div className="flex items-center gap-3 rounded-2xl bg-white/95 p-3 pr-4 shadow-[0_16px_40px_-12px_rgba(20,20,43,.4)] ring-1 ring-[#818CF8]/40 backdrop-blur-md">
        <span className="flex h-10 w-10 shrink-0 items-center justify-center rounded-full bg-gradient-to-br from-[#701A75] to-[#A78BFA] text-[15px] font-black text-white">
          {it.n[0]}
        </span>
...
function TestimonialCard({ r }: { r: (typeof TESTIMONIALS)[number] }) {
  return (
    <div className="rounded-2xl bg-white/85 p-4 shadow-lg ring-1 ring-[#1E3A8A]/15">
      <div className="flex items-center gap-3">
        <span className="flex h-10 w-10 shrink-0 items-center justify-center rounded-full bg-gradient-to-br from-[#701A75] via-[#A78BFA] to-[#F472B6] text-[15px] font-black text-white">
          {r.n[0]}
        </span>
...
/* Landing                                                             */
/* ================================================================== */
export default function AjusteurCeintureTkLanding() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-[#F5F3FF] via-[#EDE9FE] to-[#FDF2F8] pb-28 text-neutral-900">
      <style>{`
        ...
        .aj-grad { background: linear-gradient(120deg,#F472B6,#A78BFA 50%,#FCD34D); -webkit-background-clip:text; background-clip:text; color: transparent; }
        ...
        .aj-cta-rose { background-image: linear-gradient(90deg,#9F1239,#F43F5E,#FB7185); color: #FFFFFF; }
      ...
      <section className="relative overflow-hidden bg-gradient-to-br from-[#1A0B2E] via-[#701A75] to-[#312E81] px-4 pb-12 pt-10 text-white">
        <div className="pointer-events-none absolute -left-24 -top-24 h-72 w-72 rounded-full bg-[#A78BFA]/25 blur-3xl" />
        ...
        <div className="relative mx-auto max-w-[560px] text-center">
          ...
          <div className="relative mx-auto mt-6 max-w-[380px]">
            <div className="absolute -inset-3 rounded-[34px] bg-gradient-to-br from-[#A78BFA]/30 via-[#F472B6]/25 to-[#F59E0B]/30 blur-xl" />
      ...
      {/* ==================== COMPTE À REBOURS ==================== */}
      <section className="bg-gradient-to-b from-[#1A0B2E] via-[#701A75] to-[#1A0B2E] px-4 py-9">
        <div className="aj-glass relative mx-auto max-w-[560px] overflow-hidden rounded-[28px] p-6 text-center shadow-2xl">
          <div className="pointer-events-none absolute -right-10 -top-10 h-32 w-32 rounded-full bg-[#F472B6]/30 blur-2xl" />
      ...
      <section className="bg-gradient-to-b from-[#EEF2FF] to-[#C7D2FE]/50 px-4 py-8 sm:py-10">
        <div className="mx-auto max-w-[560px]">
          ...
          <div className="mx-auto mt-5 max-w-sm"><AjCTA variant="rose" onClick={() => openModal()}>Ajuster tous mes pantalons</AjCTA></div>
        </div>
      </section>
      ...
      <MediaBlock
        ...
        bg="bg-gradient-to-b from-[#1A0B2E] via-[#6D28D9] to-[#4C1D95]"
      ...
      <MediaBlock
        ...
        bg="bg-gradient-to-b from-[#0F172A] via-[#701A75] to-[#1A0B2E]"
      ...
      <section className="bg-gradient-to-b from-[#E0E7FF] to-[#C7D2FE]/40 px-4 py-12">
        <div className="mx-auto max-w-[560px]">
          ...
          <div className="mx-auto mt-6 max-w-sm"><AjCTA variant="rose" onClick={() => openModal()}>Rejoindre les clients satisfaits</AjCTA></div>
        </div>
      </section>
      ...
      {/* ==================== OFFRE / URGENCE ==================== */}
      <section className="bg-gradient-to-b from-[#1A0B2E] via-[#701A75] to-[#312E81] px-4 py-12 text-white">
      ...
      {/* ==================== FOOTER COD ==================== */}
      <footer className="bg-gradient-to-b from-[#1A0B2E] to-[#0B0A1A] px-4 pb-8 pt-6 text-center text-[10.5px] text-white/60">
