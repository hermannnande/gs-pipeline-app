<?php
/**
 * Configuration — Sac Louis Vuitton (Pochette Homme Premium)
 * ==========================================================
 ...
 *
 * Emplacement : /web/sac-lv/config.php
 */
...
// ─── Meta Conversions API (CAPI) — sac-louis-vuitton ───────────────────
// Token : Meta Business → Paramètres → Conversions API → Générer un token
// d'accès pour le pixel. Pixel vide par défaut : le client le fournira.
