...
const PRODUCT = {
  code: 'SANGLE_ROTULIENNE_TK',
  nom: 'SANGLES ROTULIENNES REGLABLES (PAIRE) — TikTok',
  description: 'Paire de sangles rotuliennes reglables (maintien du genou) : silicone souple, ajustement precis, maintien leger et confort respirant. Pour le sport, la randonnee, le travail debout et les douleurs du genou. Canal TikTok (page sangles-rotuliennes-tk).',
  prixUnitaire: 9900,
  prix2Unites: 18900,
  prix3Unites: 26900,
  stockActuel: 50,
...
const list = await fetch(`${API_URL}/products?search=SANGLE`, { headers: { Authorization: `Bearer ${token}` } });
