...
const PRODUCT = {
  code: 'BANDES_BUCCALES_SOMMEIL_TK',
  nom: 'BANDES BUCCALES POUR LE SOMMEIL (PAQUET DE 30) — TikTok',
  description: 'Paquet de 30 bandes buccales (mouth tape) pour le sommeil : adhesif doux hypoallergenique, favorise la respiration nasale la nuit, aide a reduire le ronflement et la bouche seche. Canal TikTok (page bandes-buccales-sommeil-tk).',
  prixUnitaire: 9900,
  prix2Unites: 18900,
  prix3Unites: 26900,
  stockActuel: 50,
