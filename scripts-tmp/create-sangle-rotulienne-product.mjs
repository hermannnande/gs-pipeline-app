...
const PRODUCT = {
  code: 'SANGLE_ROTULIENNE',
  nom: 'SANGLES ROTULIENNES REGLABLES (PAIRE)',
  description: 'Paire de sangles rotuliennes reglables (maintien du genou) : silicone souple, ajustement precis, maintien leger et confort respirant. Pour le sport, la randonnee, le travail debout et les douleurs du genou. Page sangles-rotuliennes.',
  prixUnitaire: 9900,
  prix2Unites: 18900,
  prix3Unites: 26900,
  stockActuel: 50,
