...
const PRODUCT = {
  code: 'SUPPORT_TELEPHONE_FLEXIBLE_TK',
  nom: 'SUPPORT TELEPHONE FLEXIBLE MAINS LIBRES — TikTok',
  description: 'Support telephone flexible mains libres (gooseneck) : se porte autour du cou, se pose sur lit/bureau/canape, se fixe sur appui-tete de voiture et guidon de velo. Pince universelle tous smartphones, bras ajustable 360°. Canal TikTok (page support-telephone-flexible-tk).',
  prixUnitaire: 9900,
  prix2Unites: 16900,
  prix3Unites: 24900,
  stockActuel: 50,
