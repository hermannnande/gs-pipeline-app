/**
 * Compression crème eczéma :
 *   - PNG/JPG dans raw/ -> WebP Q=52, max 800px -> n1..n3.webp
 *   - MP4 dans raw/ -> H264 CRF 32, 540p, no audio -> w1/w2.mp4
 *   - Posters vidéo -> w1p.webp, w2p.webp
 *
 * Usage : node scripts/compress-creme-eczema.mjs
 */
...
const SRC_DIR = 'frontend/public/creme-eczema/raw';
const DST_DIR = 'frontend/public/creme-eczema';
