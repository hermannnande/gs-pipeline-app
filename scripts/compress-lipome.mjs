/**
 * Convertit les sources m1..m13 en WebP < 200 KB (max 880 px), supprime les .src.
 * Garde les .mp4 tels quels.
 */
...
const DIR = path.resolve(__dirname, '../frontend/public/lipome');
