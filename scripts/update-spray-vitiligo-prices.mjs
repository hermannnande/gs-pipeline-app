/**
 * Met a jour les prix du produit CREME_VITILIGO en base (via l'API admin).
 *
 * Le montant reellement facture est calcule cote serveur par computeTotalAmount
 * a partir de product.prixUnitaire / prix2Unites / prix3Unites :
 *   - qty 1 (1 flacon)  -> prixUnitaire
 *   - qty 2 (2 flacons) -> prix2Unites
 *   - qty 3 (3 flacons) -> prix3Unites
 *
 ...
 *   3 flacons = 24 900 F
 *
 * Usage : node scripts/update-spray-vitiligo-prices.mjs
 */
...
async function findProduct(token) {
  const res = await fetch(`${API_URL}/products?search=VITILIGO`, {
