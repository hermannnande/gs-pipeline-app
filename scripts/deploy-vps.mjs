...
function packageBuild() {
  ...
  if (FLAGS.withImages) {
    candidates.push('verrue-tk', 'creme-anti-verrue', 'spray-douleur', 'spray-lipome', 'lipome', 'serum-yeux', 'creme-minceur', 'patch-douleur-tk', 'poudre-pousse-cheveux', 'chaussettes-homme', 'creme-anti-cerne', 'coffret-boxer-homme', 'spray-vitiligo', 'creme-verrue-tk-v2');
  }
...
for img_dir in verrue-tk creme-anti-verrue spray-douleur spray-lipome lipome serum-yeux creme-minceur patch-douleur-tk poudre-pousse-cheveux chaussettes-homme creme-anti-cerne coffret-boxer-homme spray-vitiligo creme-verrue-tk-v2; do
  if [ -d "$img_dir" ]; then
