/**
 * Met a jour les prix BANDE_SPORT_MINCEUR (slug bande-sport-minceur).
 * 1 bande = 7 000 F | 2 bandes = 12 000 F | 3 bandes = 15 000 F
 */
...
async function findProduct(token) {
  const res = await fetch(`${API_URL}/products?search=BANDE_SPORT`, {
...
const ok = [7000, 12000, 15000].every((v, i) => [verif.prixUnitaire, verif.prix2Unites, verif.prix3Unites][i] == v);
