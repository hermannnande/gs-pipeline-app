/**
 * Met a jour les prix du produit PATCH_DOULEUR_TIKTOK en base (via l'API admin).
 *
 * Prix TikTok :
 *   1 boite  = 7 500 F
 *   2 boites = 12 100 F
 *   3 boites = 17 700 F
 * Usage : node scripts/update-patch-douleur-tiktok-prices.mjs
 */
...
async function findProduct(token) {
  const res = await fetch(`${API_URL}/products?search=PATCH`, {
