/**
 * Met a jour les prix LUNETTE_VISION_NOCTUNE (slug lunette-de-nuit).
 * 1 paire = 7 000 F | 2 paires = 12 000 F | 3 paires = 15 000 F
 */
...
async function findProduct(token) {
  const res = await fetch(`${API_URL}/products?search=LUNETTE`, {
