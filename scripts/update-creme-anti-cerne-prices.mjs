/**
 * Met a jour les prix du produit CREME_ANTI_CERNE (slug creme-anti-cerne).
 *   1 crème  = 9 900 F
 *   2 crèmes = 16 900 F
 *   3 crèmes = 24 900 F
 *
 * Usage : node scripts/update-creme-anti-cerne-prices.mjs
 */
...
async function findProduct(token) {
  const res = await fetch(`${API_URL}/products?search=CERNE`, {
...
const ok = Number(verif.prixUnitaire) === 9900 && Number(verif.prix2Unites) === 16900 && Number(verif.prix3Unites) === 24900;
