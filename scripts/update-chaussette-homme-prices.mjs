/**
 * Met a jour les prix du produit CHAUSSETTE_HOMME en base (via l'API admin).
 *
 ...
 *   - qty 1 (5 paires)  -> prixUnitaire
 *   - qty 2 (10 paires) -> prix2Unites
...
async function findProduct(token) {
  const res = await fetch(`${API_URL}/products?search=CHAUSSETTE`, {
